...
DATABASES = {
    'default': {
        ...
        'NAME':  'tsj',                      # Or path to database file if using sqlite3.
        'USER': 'tsj_user',                      # Not used with sqlite3.
        'PASSWORD': 'fV4sRMISXfEGN5yzOJTvOSLmFvmVIG',                  # Not used with sqlite3.
...
SECRET_KEY = 'Z`Yjuk-#:z7iUk~:%`yD$OZU&51qn0HHC-}fr(Fm&|QHY%69hi'
